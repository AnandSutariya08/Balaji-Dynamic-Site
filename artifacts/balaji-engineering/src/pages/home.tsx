      ...
      <div ref={containerRef} className="bg-black">
              ...
              >
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/20 border border-primary/50 text-primary mb-8">
                  <span className="text-[10px] font-bold tracking-[0.3em] uppercase">
                    EST. 2001 • NAVAGAM, SURAT • GST: 24BCUPS8314Q1ZK
                  </span>
                </div>
                ...
                <h1 className="flex flex-col text-7xl md:text-9xl font-display font-black leading-[0.9] text-white uppercase tracking-tighter mb-8">
                  ...
                  <motion.span 
                    ...
                    className="text-transparent bg-clip-text bg-gradient-to-r from-[#AC3C3C] to-[#1a3a6a]"
                  >
                    PRECISION
                  </motion.span>
                  <motion.span 
                    ...
                    className="text-2xl font-bold tracking-[0.5em] mt-4 opacity-70"
                  >
                    SINCE 2001
                  </motion.span>
                </h1>
        ...
        <section className="py-32 bg-black relative overflow-hidden">
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-[0.03]">
            <span className="text-[40rem] font-display font-black">25</span>
          </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-16">
              {[
                ...
                <div key={i} className="flex flex-col items-center text-center">
                  <div className="text-5xl md:text-7xl font-display font-black text-white mb-4">
                    <Counter value={stat.value} prefix={stat.prefix} suffix={stat.suffix} />
                  </div>
                  <div className="h-1 w-12 bg-primary mb-6" />
                  <div className="text-xs font-bold tracking-[0.3em] text-zinc-500 uppercase">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-24 items-center">
              ...
              <div ref={aboutTextRef} className="space-y-12">
                ...
                <div className="space-y-6 text-xl text-zinc-400 font-light leading-relaxed reveal-line">
                  <p>
                    Established in 2001, Balaji Engineering Works has evolved from a small workshop into a premier industrial power-house in Surat, Gujarat.
                  </p>
                  <p>
                    We specialize in heavy-duty shearing, CNC laser cutting, and complex plate fabrication. Our commitment to accuracy and turnaround time has made us the trusted partner for India's leading infrastructure and automotive firms.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-8 reveal-line">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-bold text-white uppercase tracking-widest">{fact}</span>
                    </div>
                  ))}
                </div>

                <div className="reveal-line pt-8">
                  <Button size="lg" variant="outline" className="h-16 px-10 border-white/20 text-white hover:bg-white/10 uppercase font-bold tracking-widest" asChild>
        ...
        <section className="py-32 bg-black border-y border-white/5">
          <div className="container mx-auto px-4 mb-12">
            <div className="flex flex-col md:flex-row justify-between items-end gap-8">
              ...
              <Button variant="ghost" className="text-white hover:text-primary transition-colors font-bold uppercase tracking-widest" asChild>
        ...
        <section className="py-32 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-24">
              ...
              <h2 className="text-5xl md:text-6xl font-display font-black text-black uppercase tracking-tighter mt-4">
                How We Work
              </h2>
            </div>
            ...
            <div className="relative">
              ...
              <motion.div 
                ...
                className="absolute top-1/2 left-0 h-1 bg-zinc-100 hidden lg:block -translate-y-1/2"
              />
              ...
              <div className="grid lg:grid-cols-4 gap-12 relative z-10">
                {[
                  ...
                  <motion.div 
                    ...
                    className="bg-zinc-50 p-10 rounded-2xl border border-zinc-100 group hover:bg-black transition-colors duration-500"
                  >
                    <div className="text-5xl font-display font-black text-zinc-200 mb-8 group-hover:text-primary transition-colors">{step.num}</div>
                    <h4 className="text-xl font-display font-black text-black uppercase tracking-tight mb-4 group-hover:text-white transition-colors">{step.title}</h4>
                    <p className="text-zinc-500 font-light leading-relaxed group-hover:text-zinc-400 transition-colors">{step.desc}</p>
                  </motion.div>
                ))}
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <motion.div 
                  ...
                  className="p-12 bg-zinc-900/30 rounded-2xl border border-white/5 hover:border-primary/50 transition-colors group"
                >
                  ...
                  <h4 className="text-2xl font-display font-black text-white uppercase tracking-tight mb-4">{sector.name}</h4>
                  <p className="text-zinc-500 font-light">{sector.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-24 items-center">
              <div>
                ...
                <h2 className="text-5xl md:text-7xl font-display font-black text-white uppercase tracking-tighter mt-4 mb-12">
                ...
                <div className="grid sm:grid-cols-2 gap-10">
                  {[
                    ...
                    <div key={i} className="flex gap-4">
                      ...
                      <div>
                        <h5 className="text-white font-bold uppercase tracking-widest text-sm mb-2">{item.title}</h5>
                        <p className="text-zinc-500 text-xs leading-relaxed font-light">Industry-leading standards and expertise since 2001.</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="relative">
                ...
                <img src="/service-cnc.png" alt="CNC Precision" className="relative z-10 rounded-2xl border border-white/10" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 bg-white">
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-end mb-24">
              ...
              <Button variant="ghost" className="text-black hover:text-primary transition-colors font-bold uppercase tracking-widest" asChild>
            ...
            <div className="grid md:grid-cols-3 gap-12">
              {[
                ...
                <Link key={i} href={`/blog/${post.slug}`} className="group">
                  <div className="aspect-video bg-zinc-100 rounded-xl overflow-hidden mb-8 border border-zinc-200">
                    <div className="w-full h-full bg-zinc-200 group-hover:bg-primary/10 transition-colors flex items-center justify-center">
                      <Play className="w-12 h-12 text-zinc-400 group-hover:text-primary transition-colors" />
                    </div>
                  </div>
                  <span className="text-primary font-bold text-xs uppercase tracking-widest">{post.cat}</span>
                  <h4 className="text-2xl font-display font-black text-black uppercase tracking-tight mt-4 group-hover:text-primary transition-colors">{post.title}</h4>
                </Link>
              ))}
            </div>
          </div>
