...
export const siteConfig = {
  ...
  description:
    "SheetMetalBendingWorks.com is the digital home of Balaji Engineering Works, a Surat-based manufacturer and service provider for sheet metal forming industries in Surat, CNC press brake bending, CNC laser cutting, CNC plasma cutting, plate rolling, shearing cutting, profile cutting, and heavy fabrication.",
  phone: "+919978753398",
