...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildMetadata({
    title:
      count > 0
        ? `Sheet Metal Bending Works Gallery - ${count} CNC Laser Cutting & Fabrication Photos | Balaji Engineering Works Surat`
        : "Sheet Metal Bending Works Gallery - CNC Laser Cutting & Fabrication Photos | Balaji Engineering Works Surat",
    description:
      count > 0
        ? `Browse ${count} photos of sheet metal bending works, CNC laser cutting, plasma cutting, plate bending, welding, and finished industrial products from Balaji Engineering Works in Surat, Gujarat.`
        : "Browse photos of sheet metal bending works, CNC laser cutting, plasma cutting, plate bending, welding, and finished industrial products from Balaji Engineering Works in Surat, Gujarat.",
    path: "/gallery",
    keywords: [
